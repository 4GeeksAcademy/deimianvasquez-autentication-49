...
Revision ID: b63dcb702cd8
Revises: 0763d677d453
Create Date: 2025-06-10 00:19:33.786954
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('lasname', sa.String(length=80), nullable=False))
